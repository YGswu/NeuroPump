...
def visualize_suite(rendering, rays):
  ...
  # distance_check = rendering['distance_check']
  ...
  vis_depth_mean, vis_depth_median = [ #TODO distance Check
      visualize_cmap(x, acc, cm.get_cmap('grey'), curve_fn=depth_curve_fn)
      for x in [distance_mean, distance_median] # TODO distance Check
  ]
  ...
  vis = {
      ...
      #'depth_check': vis_depth_check, TODO: Deborah depth
